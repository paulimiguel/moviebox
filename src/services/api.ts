...
export const api = {
  ...
  uploads: {
    ...
    tmdb: {
      ...
      platformSuggestions: (platform: string, seed = 0, filter = 'novedades') => request<TmdbSuggestionCandidate[]>(`/tmdb/platform-suggestions?platform=${platform}&seed=${seed}&filter=${filter}`),
